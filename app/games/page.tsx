                ...
                <Card key={game.id} onClick={() => router.push(`/games/${game.id}`)}>
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm">Start: {formatDateTime(game.start)}</p>
                      <p className="text-sm">End: {formatDateTime(game.end)}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-sm text-gray-600">Points</p>
                      <p className="text-sm">Winner: {game.winnerPts}</p>
                      <p className="text-sm">Loser: {game.loserPts}</p>
                    </div>
                  </div>
                </Card>
              );
